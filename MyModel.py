...
image_size = (512, 512, 4)  # Define the desired image size
    ...
    for file in os.listdir(data_dir):
        if file.endswith('.png') and file.startswith('scene'):
           # Load RGB image
            ...
            rotation_angle = int(file.split('_')[-1])  # Get the last part of the filename
            ...
            combined_image = np.dstack((image, depth))
